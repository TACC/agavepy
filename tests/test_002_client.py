...
def test_client_restore_direct(bare_testing_env, test_api_server, test_forever_token):
    """Can init bare client config from params
    """
    from agavepy.agave import Agave
    client = Agave._restore_direct(api_server=test_api_server, token=test_forever_token)
...
@pytest.mark.smoketest
def test_client_restore_env_basic(basic_testing_env, basic_client, test_username):
...
@pytest.mark.smoketest
def test_client_restore_generic(temp_testing_env, test_client, tapis_py_log_level_debug):
    """Can read refresh client config from ENV
    """
    from agavepy.agave import Agave
...
@pytest.mark.smoketest
def test_bare_client_param(temp_testing_env, test_api_server, test_forever_token, test_username, tapis_py_log_level_debug):
...
def test_bare_client_param_refresh(temp_testing_env, test_api_server, test_forever_token):
...
def test_bare_client_env_restore(bare_testing_env, test_api_server, test_forever_token):
...
def test_bare_client_no_write_cache(temp_testing_env, test_api_server, test_forever_token):
    """Client.refresh() does not fail for token-only client
    """
    from agavepy.agave import Agave
    ag = Agave(api_server=test_api_server, token=test_forever_token)
